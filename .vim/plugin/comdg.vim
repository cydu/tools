...
function! <SID>GetEmail()
  return "chuanying@staff.sina.com.cn"
endfunction

function! <SID>GetWeibo()
  return "weibo.com/cydu"
endfunction
...
function! <SID>GetDoxFileHeader(leading_blank)
	...
	let doc = ""
  let doc = doc. a:leading_blank."/***************************************************************************\n"
  let doc = doc. a:leading_blank." * Copyright (c) ".<SID>GetYear()." Weibo.com, Inc. All Rights Reserved\n"
  let doc = doc. a:leading_blank." * \$Id\$ \n"
  let doc = doc. a:leading_blank." **************************************************************************/\n \n "
  let doc = doc. a:leading_blank."/**\n"
	let doc = doc. a:leading_blank." * @file ".<SID>GetFileName()."\n"
	let doc = doc. a:leading_blank." * @author ".<SID>GetUserName()."(".<SID>GetEmail()." ".<SID>GetWeibo().")\n"
	let doc = doc. a:leading_blank." * @date ".<SID>GetDate()."\n"
...
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,php nnoremap <silent> <Leader>a :call <SID>GetDoxFH(0)<CR>
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,php nnoremap <silent> <Leader>s :call <SID>GetDoxFH(1)<CR>
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,php nnoremap <silent> <Leader>d :call <SID>GetDoxFH(2)<CR>
autocmd FileType c,cpp,java,sh,awk,vim,sed,perl,php nnoremap <silent> <Leader>f :call <SID>GetDoxFH(3)<CR>
